    ...
    seasons = {
        ...
        ["midnight-s2"] = {
            ...
            dungeons = {
                ...
                -- ids/icons from /keyf dumpmaps (live MapChallengeMode).
                { id = 249, name = "Kings' Rest", short = "KR", icon = 2178730, teleports = { 1286831 } },
                { id = 399, name = "Ruby Life Pools", short = "RLP", icon = 4746639, teleports = { 393256 } },
                { id = 250, name = "Temple of Sethraliss", short = "TOS", icon = 2178734, teleports = { 1286828 } },
            },
        },
    },
}
